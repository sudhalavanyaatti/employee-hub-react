  ...
  render() {
    return ( 
           ...
           <div className="btmnavbar">
            ...
            <SocialIcon url="http://facebook.com" network="facebook" bgcolor="#FFFFFF" style={{ height: 25, width: 25 }} />
            <SocialIcon url="http://twitter.com"  fgcolor="#ff6a01" style={{ height: 25, width: 25 }} />
